function Prize( ctx, x, y ) {
    var _this = this, prizeRes, egg2_1Res, measure, x1, y1, x2, y2, fontSize = 40*width/350, giftRes, gs2Res;
    prizeRes = getRes('prize'+ eggI);
    egg2_1Res = getRes('egg');
    giftRes = getRes('gift');
    gs2Res = getRes('gs2');
    ...
    this.gs2Y = ( this.stageH - gs2Res['height'] ) - 150*width/370;
    ...
    function success() {
        ...
        // 奖品光束
        ctx.drawImage( gs2Res['image'], this.gs2X, this.gs2Y, gs2Res['width'], gs2Res['height']-40 );
